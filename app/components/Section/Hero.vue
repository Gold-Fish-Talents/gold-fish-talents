...
<template>
  <section class="overlay isloate relative -left-2 isolate flex h-screen w-screen items-stretch overflow-hidden md:-left-4">
    ...
    <div
      ...
      <!-- Left tagline -->
      <p class="row-start-2 w-full max-w-80 space-y-4 justify-self-auto text-white/80 md:col-start-1 md:row-start-1 md:mx-0 md:justify-self-start">
        Your project is a universe.<br />
        We help you fill it with the right stars, planets, and cosmic energy it needs to come alive.
      </p>
      <!-- Right tagline -->
      <p class="font-semibold row-start-3 w-full max-w-80 justify-self-auto uppercase text-white/80 md:col-start-2 md:row-start-1 md:mx-0 md:justify-self-end md:text-right">
