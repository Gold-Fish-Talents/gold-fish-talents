...
type ModelUpdateFormData = z.infer<typeof modelFormSchema>
  ...
  <form class="flex flex-col gap-5" novalidate @submit.prevent="onSubmit">
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="mt-2 flex gap-3">
          <label class="inline-flex items-center gap-2">
            <input v-model="r$.$value.gender" type="radio" value="male" disabled class="disabled:cursor-not-allowed disabled:opacity-60" />
            <span class="text-sm">Male</span>
          </label>
          <label class="inline-flex items-center gap-2">
            <input v-model="r$.$value.gender" type="radio" value="female" disabled class="disabled:cursor-not-allowed disabled:opacity-60" />
            <span class="text-sm">Female</span>
          </label>
          <label class="inline-flex items-center gap-2">
            <input v-model="r$.$value.gender" type="radio" value="other" disabled class="disabled:cursor-not-allowed disabled:opacity-60" />
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
      ...
      <!--  <div class="mt-6 flex items-center gap-2">
        <input id="same" v-model="r$.$value.sameAsPhone" type="checkbox"
          class="size-4 disabled:cursor-not-allowed disabled:opacity-60" />
        <label for="same" class="text-slate-300 text-sm">WhatsApp same as phone</label>
      </div>
      <div class="flex flex-col gap-3">
        <label for="whatsapp"
          class="font-medium text-slate-300 text-sm after:ml-1 after:text-alert-500 after:content-['*']">WhatsApp
          number</label>
        <input id="whatsapp" v-model="r$.$value.whatsapp" :disabled="r$.$value.sameAsPhone" type="tel" inputmode="tel"
