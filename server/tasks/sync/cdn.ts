...
export default defineTask({
  ...
  async run() {
    ...
    for await (const [slug, id] of Object.entries(assets)) {
      ...
      // update cover -> https://cdn.goldfishtalents.com/media/w_1620&h_1080/product-photo-033-033
      ...
      try {
        ...
        updateCoverURL = `https://cdn.goldfishtalents.com/media/image/s_${coverWidth}x${coverHeight}/${slug}`
        ...
        console.log('🚩 Failed Updating', { slug }, error)
      }
    }
